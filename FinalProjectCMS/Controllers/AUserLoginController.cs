...
namespace FinalProjectCMS.Controllers
{
    ...
    public class AUserLoginController : ControllerBase
    {
        ...
        private TblLoginUsers AuthenticateUser(string username, string password)
        {
            TblLoginUsers user = _loginRepository.validateUser(username, password);
        ...
        private string GenerateJSONWebToken(TblLoginUsers user)
        {
            //security key
        ...
        public IActionResult userLogin(string username, string password)
        {
            ...
            TblLoginUsers dbLogin = AuthenticateUser(username, password);
